...
-- =========================================================================
-- ESQUEMA DE BASE DE DATOS LOCAL DOCKER: DARAVISA
-- =========================================================================
...
-- =========================================================================
-- ESTRUCTURA DE BASE DE DATOS: MÃ“DULO DE DOCUMENTOS Y FIRMAS DIGITALES
-- =========================================================================
...
-- Si la tabla ya existÃ­a, agregar columnas para soporte de PDF original:
...
-- =========================================================================
-- ESQUEMA BASE DE DATOS: MÃ“DULO DE FACTURAS RECIBIDAS (CFDI SAT)
-- =========================================================================
...
CREATE TABLE IF NOT EXISTS public.facturas_recibidas (
  ...
  tipo_comprobante text DEFAULT 'I', -- 'I': Ingreso, 'E': Egreso, 'P': Pago, 'N': NÃ³mina
...
-- Ãndices de alto rendimiento para facturas_recibidas
...
-- 2. Tabla de Control de Solicitudes AsÃ­ncronas de Descarga Masiva del SAT
...
DO $$
BEGIN
  -- PolÃ­ticas para facturas_recibidas
  IF NOT EXISTS (
  ...
  -- PolÃ­ticas para sat_descarga_solicitudes
  IF NOT EXISTS (
...
-- 4. CreaciÃ³n del Storage Bucket para los XMLs si no existe
...
-- =========================================================================
-- AUTOMATIZACIÃ“N DIARIA DE SINCRONIZACIÃ“N CON EL SAT - DARAVISA (6:00 AM)
-- =========================================================================
-- Este script programa un Cron Job en la base de datos de Daravisa en Supabase
-- para invocar la Edge Function 'sync-facturas-recibidas' todos los dÃ­as
-- a las 6:00 AM (Hora Centro de MÃ©xico / 12:00 UTC).
-- =========================================================================
...
-- Otorgar permisos de ejecuciÃ³n a postgres
GRANT USAGE ON SCHEMA cron TO postgres;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA cron TO postgres;

-- 2. Eliminar programaciÃ³n anterior si ya existÃ­a para evitar duplicados
DO $$
BEGIN
  PERFORM cron.unschedule('sync-facturas-sat-diario-6am-daravisa');
EXCEPTION WHEN OTHERS THEN
  -- Ignorar si no existÃ­a el job previo
END $$;
