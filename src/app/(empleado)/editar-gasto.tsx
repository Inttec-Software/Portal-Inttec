              ...
              {facturado === false && (
                <View style={{ marginBottom: Spacing.two }}>
                  <CustomInput
                    ...
                    placeholder={motivoSinFactura.startsWith('PENDIENTE') ? "Escribe la razón (ej: PENDIENTE_ENTREGA: Me la mandan mañana)" : "Ej. El establecimiento no emite facturas, etc."}
